...
exports.create = (req, res) => {
  ...
  if (!req.body.name) {
   ...
   const user = new User({
    name: req.body.name,
    role: req.body.role,
    online_status: req.body.online_status ? req.body.online_status : false
  });
...
exports.findAllOnline = (req, res) => {
  User.find({ online_status: true })
    ...
    .catch(err => {
      res.status(500).send({
        message:
          err.message || "Some error occurred while retrieving online Users."
      });
    });
